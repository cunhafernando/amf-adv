...
class ArtigosControllerTest < ActionController::TestCase
  ...
  test "should create artigo" do
    assert_difference('Artigo.count') do
      post :create, artigo: { autor: @artigo.autor, conteudo: @artigo.conteudo, data: @artigo.data, titulo: @artigo.titulo }
    end
  ...
  test "should update artigo" do
    put :update, id: @artigo, artigo: { autor: @artigo.autor, conteudo: @artigo.conteudo, data: @artigo.data, titulo: @artigo.titulo }
    assert_redirected_to artigo_path(assigns(:artigo))
  end
