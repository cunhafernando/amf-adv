...
class ClausulasControllerTest < ActionController::TestCase
  ...
  test "should create clausula" do
    assert_difference('Clausula.count') do
      post :create, clausula: { autor: @clausula.autor, conteudo: @clausula.conteudo, data: @clausula.data, titulo: @clausula.titulo }
    end
  ...
  test "should update clausula" do
    put :update, id: @clausula, clausula: { autor: @clausula.autor, conteudo: @clausula.conteudo, data: @clausula.data, titulo: @clausula.titulo }
    assert_redirected_to clausula_path(assigns(:clausula))
  end
